            ...
            <div className="bg-emerald-50 p-4 rounded-lg border border-emerald-200">
              ...
              <div className="space-y-2">
                <div className="flex justify-between">
                  <span className="text-gray-600">CLOA Total:</span>
                  <span className="font-medium">{formData.tctCloaTotal}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">CLOA Processed:</span>
                  <span className="font-medium">{formData.tctCloaProcessed}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">EP Total:</span>
                  <span className="font-medium">{formData.tctEpTotal}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">EP Processed:</span>
