                    ...
                    <td className="px-4 py-3">
                      <span className={`inline-block px-2 py-1 rounded text-xs ${
                        ['Admin', 'admin'].includes(user.role)
                          ...
                          : ['Encoder', 'encoder'].includes(user.role)
                          ? 'bg-blue-100 text-blue-800'
                          : ['Viewer', 'viewer'].includes(user.role)
            ...
            <div className="bg-white rounded-lg shadow-xl w-full max-w-md">
              ...
              <form onSubmit={handleSubmit} className="p-4">
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        onChange={handleInputChange}
                        required={!editingUser && formData.passwordRequired}
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">
                      Confirm {editingUser ? 'New' : ''} Password
                    </label>
                    <div className="relative">
                      <input
                ...
                <div className="mt-6 flex justify-end gap-3">
                  <button
                    type="button"
                    onClick={handleCancel}
                    className="px-4 py-2 border border-gray-300 rounded-md text-gray-700 hover:bg-emerald-50"
                  >
                    Cancel
                  </button>
                  <button
                    type="submit"
                    className="px-4 py-2 bg-emerald-700 text-white rounded-md hover:bg-emerald-800 flex items-center gap-2"
                  >
